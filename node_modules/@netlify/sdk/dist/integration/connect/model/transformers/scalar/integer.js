...
export class IntegerTranformer extends ScalarBaseTransformer {
    ...
    parseVisitedInputSingle(input, field, treeContext) {
        ...
        if (!isNumber) {
            throw new ModelError(`Input data for field ${field.fieldName} at input path ${treeContext.path.join(`.`)}.${field.fieldName} is not an integer but should be. Received ${typeof input}.\n\n${JSON.stringify(input, null, 2)}`);
        }
        return input;
    }
