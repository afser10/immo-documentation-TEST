...
export declare class NetlifyIntegrationClient<SiteConfiguration, TeamConfiguration> extends NetlifyClient {
     ...
     */
    updateSiteIntegration: (siteId: string, config: SiteConfiguration) => Promise<import("wretch").WretchResponse>;
    /**
     * Updates the integration configuration for a team.
     */
    updateTeamIntegration: (teamId: string, config: TeamConfiguration) => Promise<import("wretch").WretchResponse>;
    /**
     * Disables this integration for a site, which also deletes the configuration.
     */
    disableSiteIntegration: (siteId: string) => Promise<import("wretch").WretchResponse>;
    /**
     * Disables this integration for a team, and deletes the associated configuration for the integration.
     */
    disableTeamIntegration: (teamId: string) => Promise<import("wretch").WretchResponse>;
    /**
     ...
     */
    enableBuildEventHandlers: (siteId: string) => Promise<import("wretch").WretchResponse>;
    /**
     * Disables the build hook for a site.
     */
    disableBuildEventHandlers: (siteId: string) => Promise<import("wretch").WretchResponse>;
    enableConnectors: (teamId: string) => Promise<import("wretch").WretchResponse>;
    disableConnectors: (teamId: string) => Promise<import("wretch").WretchResponse>;
}
export {};
