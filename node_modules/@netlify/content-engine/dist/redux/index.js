...
const emitter = exports.emitter = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.emitter) || (0, _mett.mett)();

// Read old node data from cache.
const readState = exports.readState = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.readState) || (() => {
  try {
...
const configureStore = exports.configureStore = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.configureStore) || (initialState => (0, _redux.createStore)((0, _redux.combineReducers)({
  ...reducers
}), initialState, (0, _redux.applyMiddleware)(_reduxThunk.default, multi)));
const store = exports.store = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.store) || configureStore(process.env.GATSBY_WORKER_POOL_WORKER ? {} : readState());

/**
 * Allows overloading some reducers (e.g. when setting a custom datastore)
 */
const replaceReducer = exports.replaceReducer = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.replaceReducer) || (customReducers => {
...
// Persist state.
const saveState = exports.saveState = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.saveState) || (() => {
...
const savePartialStateToDisk = exports.savePartialStateToDisk = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.savePartialStateToDisk) || ((keys, transformState) => {
  const state = store.getState();
  const contents = (0, _lodash.default)(state, keys);
  const savedContents = transformState ? transformState(contents) : contents;
  return (0, _persist.writeToCache)(savedContents);
});
const loadPartialStateFromDisk = exports.loadPartialStateFromDisk = (gatsbyRedux === null || gatsbyRedux === void 0 ? void 0 : gatsbyRedux.loadPartialStateFromDisk) || (() => {
  try {
