...
const initAPICallTracing = parentSpan => {
  const startSpan = (spanName, spanArgs = {}) => {
    ...
    return tracer.startSpan(spanName, (0, _lodash3.default)(defaultSpanArgs, spanArgs));
  };
  return {
    tracer,
    parentSpan,
...
function apiRunnerNode(api, args = {}, {
  ...
  return new Promise((resolve, rejectApiRunnerNode) => {
    ...
    traceTags === null || traceTags === void 0 ? void 0 : (_traceTags$forEach = traceTags.forEach) === null || _traceTags$forEach === void 0 ? void 0 : _traceTags$forEach.call(traceTags, (value, key) => {
    ...
    if (api === `setFieldsOnGraphQLNodeType`) {
      ...
      const argsJson = JSON.stringify((0, _lodash.default)(args, `parentSpan`));
    ...
    function cleanup({
      ...
      // @ts-ignore
      apiRunInstance.results = (results === null || results === void 0 ? void 0 : results.filter(result => !(0, _lodash2.default)(result))) || [];
    ...
    (async () => {
      try {
        ...
        for (const plugin of implementingPlugins) {
          const result = await (0, _importGatsbyPlugin.importGatsbyPlugin)(plugin, `gatsby-node`).then(gatsbyNode => runImportedPlugin(plugin, gatsbyNode));
          results.push(result);
        }
        cleanup({
          apiRunInstance,
...
var _default = exports.default = apiRunnerNode;
