...
function convertPathsToAbsolute(filePath) {
  ...
  return (0, _coreUtils.slash)(filePath);
}
/**
...
function createInternalJob(job, plugin) {
  ...
  internalJob.contentDigest = (0, _coreUtils.createContentDigest)({
    name: job.name,
...
async function enqueueJob(job) {
  ...
  try {
    ...
    if (result != null && !(0, _lodash.default)(result)) {
