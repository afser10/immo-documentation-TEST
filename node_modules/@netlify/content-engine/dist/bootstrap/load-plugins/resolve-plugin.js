...
var _path2 = require("../../core-utils/path");
...
function resolvePlugin(plugin, rootDir) {
   ...
   */
  try {
    const requireSource = rootDir !== null ? (0, _createRequireFromPath.createRequireFromPath)(`${rootDir}/:internal:`) : require;

    // If the path is absolute, resolve the directory of the internal plugin,
    // otherwise resolve the directory containing the package.json
    const resolvedPath = (0, _path2.slash)(_path.default.dirname(requireSource.resolve(_path.default.isAbsolute(pluginName) ? pluginName : `${pluginName}/package.json`)));
    ...
    _reporter.default.panicOnBuild(`plugin "${pluginName} threw the following error. Perhaps you need to install its package?\n\n`, err);
