...
function processPlugin(plugin, rootDir) {
  ...
  if ((0, _lodash3.default)(plugin.options) && !(0, _lodash3.default)(plugin.option)) {
  ...
  if (plugin.subPluginPaths) {
    for (const subPluginPath of plugin.subPluginPaths) {
      ...
      (0, _lodash.default)(plugin.options, pathToSwap, processed);
    }
  }
  ...
  return {
    ...
    pluginOptions: (0, _lodash2.default)({
      plugins: []
    }, plugin.options)
  };
}
