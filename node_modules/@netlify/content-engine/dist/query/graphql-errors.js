...
var _upperFirst = require("../core-utils/upper-first");
...
function getCodeFrameFromRelayError(def, extractedMessage, _error) {
  ...
  const query = source ? source.body : (0, _graphql.print)(def);
  ...
  return (0, _graphqlErrorsCodeframe.getCodeFrame)(query, line, column);
}
function multipleRootQueriesError(filePath, def, otherDef) {
  ...
  const unifiedName = `${(0, _lodash.default)(name)}And${(0, _upperFirst.upperFirst)((0, _lodash.default)(otherName))}`;
