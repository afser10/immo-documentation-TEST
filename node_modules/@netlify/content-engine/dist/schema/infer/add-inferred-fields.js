...
const {
  upperFirst
} = require(`../../core-utils/upper-first`);
const {
  ObjectTypeComposer
...
const addInferredFields = ({
  ...
  if (deprecatedNodeKeys.size > 0) {
    ...
    (0, _reportOnce.reportOnce)(`Plugin "${plugin}" is using the ___NODE convention which is deprecated. This plugin should use the @link directive instead.`, `verbose`);
  }
};
module.exports = {
  addInferredFields
