...
exports.reservedExtensionNames = exports.processFieldExtensions = exports.internalExtensionNames = exports.inferExtensionName = exports.dontInferExtensionName = exports.builtInFieldExtensions = exports.addDirectives = void 0;
...
const inferExtensionName = exports.inferExtensionName = `infer`;
const dontInferExtensionName = exports.dontInferExtensionName = `dontInfer`;
...
const builtInFieldExtensions = exports.builtInFieldExtensions = {
  dateformat: {
    name: `dateformat`,
  ...
  link: {
    ...
    extend(args, fieldConfig, schemaComposer) {
      var _schemaComposer$typeM;
      const type = args.on && ((_schemaComposer$typeM = schemaComposer.typeMapper.convertSDLWrappedTypeName(args.on)) === null || _schemaComposer$typeM === void 0 ? void 0 : _schemaComposer$typeM.getType());
      return {
        resolve: link({
          ...args,
          type
...
const internalExtensionNames = exports.internalExtensionNames = [`createdFrom`, `default`, `directives`, `infer`, `plugin`, ...specifiedDirectives.map(directive => directive.name)];
const reservedExtensionNames = exports.reservedExtensionNames = [...internalExtensionNames, ...Object.keys(builtInFieldExtensions)];
const toDirectives = ({
  schemaComposer,
  extensions,
